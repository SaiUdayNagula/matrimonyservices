...
const { sentEmail } = require('../utilities/emailOTP'); // Import the sentEmail function from emailOTP.js
  ...
  db.query(sql, [username, password], (err, result) => {
    ...
    if (response.otp !== undefined && response.otp !== -1) {
      // OTP is valid and generated, send it to frontend
        // Call the sentEmail function and pass email and otp as parameters
        sentEmail(username, response.otp);
