  ...
  return (
    <PublicLayout>
      <div className="relative h-screen flex overflow-hidden auth">
        ...
        {/* ResetPassword Form Section (30%) */}
        <div className=" w-[30%] px-[5rem] flex items-center">
          <div className="w-full">
            <div>
              <div className="">
                <img src={images.logoIcon} alt="OTP Image" className="mb-10" />
                <h1 className="text-2xl mb-4 theme-color">Reset Password</h1>
              ...
              {/* <Divider className='my-4' orientation='middle' plain>
                            ...
                            <div className='grid gap-3'>
                                ...
                                <Button
                                    ...
                                    key='google'
                                    className='border-none shadow bg-white w-full'>
                                    ResetPassword with Google
                                </Button>
                            </div> */}
              <div className="mt-[5rem] text-sm text-black">
                <hr />
                <p className="text-center mt-3 text-md">Back to Login</p>
              </div>
            </div>
          </div>
        </div>
